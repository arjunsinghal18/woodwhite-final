<nav class="menu menu-right" style="background-color:#B5CA85;">
    <p class="cross">&#x2715</p>
    <br>
    ...
    <a href="{{url('account')}}" ><p class="menu-item">My Account</p> </a>
    <a href="{{url('order')}}" ><p class="menu-item">Order</p> </a>
    ...
    <div class="login-form" style="padding-left:25px; width:80%; text-align:left; display:none; ">
        ...
        <br>
        <center>
        <a href="{{url('/login/google')}}" class="tn oogle"><i class="fa fa-google-plus fa-2x" aria-hidden="true"></i></a>&nbsp;&nbsp;
        <a href="{{url('/login/facebook')}}" class="tn facebok"><i class="fa fa-facebook fa-2x" aria-hidden="true"></i></a>
        </center>
    </div>
